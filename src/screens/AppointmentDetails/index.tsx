import { FlatList, ImageBackground, Linking, Pressable, Share, StyleSheet, Text, View } from 'react-native';
  ...
  return (
    <Background>
      ...
      <View style={styles.listHeader}>
        <ListHeader title="Jogadores" subtitle={`Total ${appointment.members.length}`} />
      </View>
      ...
      <View style={[styles.footer, { paddingBottom: Math.max(bottom + 6, 24) }]}>
        <ButtonIcon
...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: fonts.title700, fontSize: 28, color: colors.heading },
  subtitle: {
    marginTop: 12,
    maxWidth: 311,
  ...
  listHeader: { marginTop: 24 },
  members: { marginTop: 24 },
  membersContent: { paddingHorizontal: metrics.screenPadding },
  footer: { paddingHorizontal: metrics.screenPadding, paddingTop: 16 },
});
